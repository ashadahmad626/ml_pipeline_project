...
class PredictionPipeline:
    ...
    def predict(self, features):
        try:  # Added try-except
            # Fixed: preprocessor → preprcessor.pkl (match your saved file)
...
class CustomDataClass:  # Fixed: CustomeClass → CustomDataClass
    def __init__(self, 
                  age: int,
                  workclass: int, 
                  education_num: int, 
    ...
    def get_data_as_dataframe(self):  # Fixed: get_data_DataFrame → snake_case
        try:
            custom_input = {
                "age": [self.age],
            ...
            raise CustomException(e, sys)  # Fixed: CustmeException → CustomException
